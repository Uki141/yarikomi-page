<template>
  <v-container fluid class="home-games" :style="styles">
    <v-row class="game-container">
      <div class="left-game" @click="focus = 'left'">
        <div class="game-article bg-bpl">
          <GameArticle>
            <template #title>beatmania IIDX</template>
            <template #subtitle>KONAMIの誇る 元祖音ゲー</template>
            <template #main>
            ...
            <template #media>
              <iframe width="560" height="315" src="https://www.youtube.com/embed/oI-AHudJNrk"
      ...
      <div class="right-game" @click="focus = 'right'">
        <div class="game-article bg-sekai">
          <GameArticle>
            <template #title>プロジェクトセカイ</template>
            <template #subtitle>一緒に歩み出そう、想いのセカイへ</template>
            <template #main>
              <p>スマホやタブレットでできる</p>
            ...
            <template #media>
              <iframe width="560" height="315" src="https://www.youtube.com/embed/aq8-3XKKI0c"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            </template>
